...
def scrapeo (año,division):
    ...
    carpeta_descargas = os.path.abspath("C:/Users/Usuario/OneDrive/Escritorio/nuevoProyectoIvana/inputs")  # Cambia esta ruta
    ...
    curso = driver.find_element(By.XPATH, "//input[@class='form-control input-xs' and @placeholder='Curso']")
    curso.send_keys(año)

    division = driver.find_element(By.XPATH, "//input[@class='form-control input-xs' and @placeholder='División']")
    division.send_keys(division)
